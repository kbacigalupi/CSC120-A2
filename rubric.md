...
__YES__ 1 pt: All expected methods for `Computer` class are present (**Mabye??**)
...
__YES__ 1 pt: Program prints appropriate error messages (**No error message in buying computer**)
